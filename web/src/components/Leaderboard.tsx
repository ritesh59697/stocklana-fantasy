...
export default function Leaderboard({ 
  ...
  return (
    <div className="flex-1 w-full bg-[#0a0a0a]/90 backdrop-blur-2xl border border-white/[0.08] rounded-2xl p-6 sm:p-8 shadow-2xl flex flex-col relative overflow-hidden">
        ...
        <div>
          ...
          <div className="flex flex-wrap items-center gap-2 text-gray-400 text-xs font-mono">
            {status === "live" ? (
              ...
              <span className="flex items-center gap-1 text-amber-400 bg-amber-500/10 px-2 py-0.5 rounded border border-amber-500/20" title={error || "Price feed unavailable"}>
                ⚠ Pyth Feed Offline (Reference Baseline)
              </span>
            )}
            <span className="text-gray-700">•</span>
            <span className="text-gray-400">Off-Chain Scoring Demo</span>
          </div>
        </div>
      ...
      <div className="mt-4 pt-3 border-t border-white/[0.05] text-[11px] font-mono text-gray-500 text-center">
