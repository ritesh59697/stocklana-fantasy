  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          onClick={onClose}
          className="w-full py-3 px-6 bg-white hover:bg-zinc-200 text-zinc-950 font-semibold rounded-xl transition-all shadow-md shadow-white/5 cursor-pointer text-sm active:scale-[0.99]"
        >
