...
export default function ReceiptModal({
  ...
  return (
    ...
    >
      <div 
        className="relative w-full max-w-md bg-[#0b0c10] border border-zinc-800 rounded-2xl p-6 sm:p-8 shadow-2xl shadow-black/80 text-center overflow-hidden ring-1 ring-white/5"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Success Icon */}
        <div className="mx-auto w-12 h-12 mb-4 rounded-full bg-zinc-800 border border-zinc-700/80 flex items-center justify-center text-zinc-100">
        ...
        <div className="bg-zinc-900/40 border border-zinc-800/70 rounded-xl p-4 text-left font-mono text-xs space-y-2.5 mb-6">
          ...
          <div className="border-t border-zinc-800/60 pt-2 flex justify-between items-center text-zinc-400">
            ...
            <a 
              ...
              target="_blank" 
              rel="noreferrer"
              className="text-zinc-300 hover:text-white underline font-mono text-[11px] truncate max-w-[150px]"
            >
        ...
        <div className="flex flex-col sm:flex-row gap-2.5">
          <button
            ...
            className="flex-1 py-3 px-4 bg-zinc-900 hover:bg-zinc-800 text-white font-medium rounded-xl border border-zinc-700/80 transition-all flex items-center justify-center gap-2 text-xs cursor-pointer active:scale-[0.99]"
          >
          ...
          <button
            onClick={onClose}
            className="flex-1 py-3 px-4 bg-white hover:bg-zinc-200 text-zinc-950 font-semibold rounded-xl transition-all text-xs cursor-pointer active:scale-[0.99]"
          >
